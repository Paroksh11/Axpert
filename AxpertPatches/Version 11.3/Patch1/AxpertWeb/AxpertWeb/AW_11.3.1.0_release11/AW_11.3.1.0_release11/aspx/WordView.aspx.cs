...
public partial class aspx_WordView : System.Web.UI.Page
{
    ...
    public void ExportToWord()
    {
        ...
        if (dt != null && dt.Rows.Count > 0)
        {
            ...
            //Sub head with page break
            //if (objIview.IsPageBreak == "true")
            //{
            ...
            //    }
            //    CreateDocumentWithSubHead(tables);
            //}
            //else
            //{
            //    CreateDocument(dt);
