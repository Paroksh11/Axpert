...
namespace ASB
{
    ...
    public class WebService : System.Web.Services.WebService
    {
        ...
        public string SaveDataXML(ArrayList fldArray, ArrayList fldDbRowNo, ArrayList fldValueArray, ArrayList fldDeletedArray, ArrayList deletedFldArrayValues, string files, string rid, string delRows, string changedRows, string key, string axRulesFlds = "", string axPegApprovalSave = "", string resTstHtmlLS = "")
        {
            ...
            result = tstData.CallSaveDataWS(tstData, fldArray, fldDbRowNo, fldValueArray, fldDeletedArray, deletedFldArrayValues, files, rid, delRows, changedRows, axRulesFlds, axPegApprovalSave);
        ...
        [WebMethod(EnableSession = true)]
        public string ExportARMPushToQueue(string iviewName, string iviewParams, string isListView, string IVIRCaption, string dtFormat)
        {
            string response = string.Empty;
            ...
            DATA = "{\"getreport\":{\"trace\":\"" + HttpContext.Current.Session["AxTrace"].ToString() + "\"," + purpose + "\"metadata\":\"true\",\"fetchhidcol\":\"false\",\"_dateformat\":\"" + dtFormat + "\",\"ivcaption\":\"" + IVIRCaption + "\",\"sqlpagination\":\"false\",\"params\":" + iviewParamsJson + ",\"project\":\"" + HttpContext.Current.Session["project"].ToString() + "\",\"name\":\"" + iviewName + "\",\"token\":\"d152232e23ff6523b8104196ff1b6015\",\"seed\":\"211269\",\"userauthkey\":\"" + Session["username"].ToString() + "\",\"arm_url\":\"" + HttpContext.Current.Session["ARM_URL"].ToString() + "\",\"ARMScriptURL\":\"" + ArmScriptURL + "\",\"axConfigFilePath\":\"" + axConfigFilePath + "\"}}";
            ...
            try
            {
                if (HttpContext.Current.Session["nsessionid"] != null)
                {
                    ...
                    if (result != "")
                    {
                        ...
                        xmlDoc.LoadXml(result);
                        XmlNodeList xmlNodes = default(XmlNodeList);
                        //xmlNodes = xmlDoc.SelectNodes("//sqlresultset/response/row/displaycontent");
